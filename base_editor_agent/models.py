"""
Data Models & Telemetry Definitions for BaseEditor-Window: Cytidine & Adenine Base Editing (CBE/ABE) Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Komor 2016 / Gaudelli 2017 Base Editing"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
