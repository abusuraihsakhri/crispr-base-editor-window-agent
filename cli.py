"""
Command Line Interface for Crispr Base Editor Window Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="crispr-base-editor-window-agent", description="Crispr Base Editor Window Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CRISPR BASE EDITOR WINDOW AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Crispr Base Editor Window Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Crispr Base Editor Window Agent API server on http://{args.host}:{args.port}")
