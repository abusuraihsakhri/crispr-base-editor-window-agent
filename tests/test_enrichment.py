"""
Automated Pytest for crispr-base-editor-window-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    SplicesiteDisruptionScorerEngine,
    WindowPositionHeatmapEngine,
    GenomeBrowserTrackExportEngine,
    BatchGuideRnaRankingEngine,
    ApobecOfftargetContextEngine,
    RestApiServerEngine,
    CrisprbaseeditorwindowagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CrisprbaseeditorwindowagentEnrichmentSuite()
