...
import pytest
from base_editor_agent.models import FrontierPayload, ExecutionStatus
from base_editor_agent.engine import FrontierDomainEngine
from base_editor_agent.agents import DeaminationWindowScorerAgent, BystanderMutationFilterAgent, ProductPurityPredictorAgent, BaseEditorCoordinator
from base_editor_agent.cli import main


def test_sub_agents():
    a1 = DeaminationWindowScorerAgent()
    ...
    a2 = BystanderMutationFilterAgent()
    ...
    a3 = ProductPurityPredictorAgent()
...
def test_coordinator():
    ...
    assert "Komor 2016 / Gaudelli 2017 Base Editing" in ans or "specifications" in ans
